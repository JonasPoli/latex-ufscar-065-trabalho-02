...
\begin{document}
\input{partes/01-info.tex}
\input{partes/02-pre-textual.tex}
    ...
    \input{partes/03-introducao.tex}
    \input{partes/04-desenvolvimento.tex}
    %\input{partes/05-conclusao.tex}
    ...
    %\input{partes/06-glossario.tex}
    %\input{partes/07-apendice01.tex}        
  	%\input{partes/08-anexo01.tex}
